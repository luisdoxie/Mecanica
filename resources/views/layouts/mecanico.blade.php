...
<body class="bg-gray-100 min-h-screen" x-data="{ sidebarOpen: false }">
    ...
    {{-- Sidebar --}}
    <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-amber-900 flex flex-col
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            <a href="{{ route('mecanico.dashboard') }}" @click="sidebarOpen = false"
            ...
            <a href="{{ route('mecanico.ordenes.index') }}" @click="sidebarOpen = false"
            ...
            <a href="{{ route('mecanico.ordenes.create') }}" @click="sidebarOpen = false"
            ...
            <a href="{{ route('mecanico.clientes.create') }}" @click="sidebarOpen = false"
            ...
            <a href="{{ route('mecanico.cobros.create') }}" @click="sidebarOpen = false"
            ...
            <a href="{{ route('mecanico.vehiculos.index') }}" @click="sidebarOpen = false"
    ...
    <div class="md:ml-64 flex flex-col min-h-screen">
        <header class="bg-white border-b border-gray-200 px-4 md:px-8 py-4 flex items-center justify-between sticky top-0 z-20">
            <div class="flex items-center gap-3">
                ...
                <h1 class="text-lg md:text-xl font-bold text-gray-800">@yield('header', 'Mi Panel')</h1>
            </div>
            <div class="flex items-center gap-2 md:gap-3">
                ...
                <div class="w-9 h-9 bg-amber-500 rounded-full flex items-center justify-center text-gray-900 font-bold text-sm shrink-0">
